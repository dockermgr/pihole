...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202212311130-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.com
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2022 Jason Hempstead, Casjays Developments
# @@Created          :  Saturday, Dec 31, 2022 11:30 EST
# @@File             :  install.sh
# @@Description      :
...
# Defaults variables
APPNAME="pihole"
INSTDIR="$HOME/.local/share/CasjaysDev/dockermgr/pihole"
APPDIR="$HOME/.local/share/srv/docker/pihole"
DATADIR="$HOME/.local/share/srv/docker/pihole/rootfs"
...
PIHOLE_USERNAME="${PIHOLE_USERNAME:-$DEFAULT_USERNAME}"
PIHOLE_PASSWORD="${PIHOLE_PASSWORD:-$DEFAULT_PASSWORD}"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set container hostname and domain - Default pihole
CONTAINER_HOSTNAME="$PIHOLE_VIRTUAL_HOST"
CONTAINER_DOMAINNAME="$PIHOLE_VIRTUAL_DOMAIN"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set capabilites
ADD_CAPABILITIES="SYS_ADMIN CAP_NET_BIND_SERVICE CAP_NET_RAW CAP_NET_ADMIN "
ADD_CAPABILITIES+="CAP_SYS_NICE CAP_CHOWN"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set sysctl
ADD_SYSCTL=""
ADD_SYSCTL+=""
